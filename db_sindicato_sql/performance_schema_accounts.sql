...
REPLACE  IGNORE INTO `accounts` (`USER`, `HOST`, `CURRENT_CONNECTIONS`, `TOTAL_CONNECTIONS`) VALUES (NULL,NULL,37,49),('event_scheduler','localhost',1,1),('root','localhost',5,73);
...
-- Dump completed on 2022-02-21 21:43:38
