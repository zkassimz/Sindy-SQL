...
--
-- ORDER BY:  `cost_name`,`engine_name`,`device_type`

LOCK TABLES `engine_cost` WRITE;
/*!40000 ALTER TABLE `engine_cost` DISABLE KEYS */;
REPLACE  IGNORE INTO `engine_cost` (`engine_name`, `device_type`, `cost_name`, `cost_value`, `last_update`, `comment`) VALUES ('default',0,'io_block_read_cost',NULL,'2022-02-01 01:44:21',NULL),('default',0,'memory_block_read_cost',NULL,'2022-02-01 01:44:21',NULL);
